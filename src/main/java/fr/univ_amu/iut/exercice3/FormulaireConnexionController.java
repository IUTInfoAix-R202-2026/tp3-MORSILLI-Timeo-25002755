...
public class FormulaireConnexionController {
        ...
        .bind(
            new BooleanBinding() {
              ...
              protected boolean computeValue() {
                return champMotDePasse.getText().length() < 8
                    || !champMotDePasse.getText().matches(".*[A-Z].*")
                    || !champMotDePasse.getText().matches(".*[0-9].*");
              }
            });
  }
  ...
  private void valider() {
    ...
    labelMessage.setText(
        champIdentifiant.getText() + " " + "*".repeat(champMotDePasse.getLength()));
  }
